//=====================================
//
// アニメーションコンテナ[AnimationContainer.cpp]
...
// フレームの描画処理
//==========================================
void AnimationContainer::DrawFrame(LPD3DXFRAME frame)
{
...
// メッシュコンテナの描画処理
//==========================================
void AnimationContainer::DrawMeshContainer(LPD3DXMESHCONTAINER meshContainerBase, LPD3DXFRAME frameBase)
{
...
// フレーム行列の更新
//==========================================
void AnimationContainer::UpdateFrameMatrixes(LPD3DXFRAME frameBase, LPD3DXMATRIX parentMatrix)
{
	D3DXFRAME_DERIVED* frame = (D3DXFRAME_DERIVED*)frameBase;
	LPDIRECT3DDEVICE9 pDevice = GetDevice();
...
// 特定のボーン行列の取得
//==========================================
D3DXMATRIX AnimationContainer::GetBoneMatrix(const char* boneName)
{
	char message[64];
...
// 特定のボーンを探す
//==========================================
D3DXFRAME_DERIVED* AnimationContainer::SearchBoneFrame(const char* boneName, D3DXFRAME* frame)
{
...
// アニメーション読み込み処理
//==========================================
HRESULT AnimationContainer::LoadAnimation(LPCSTR setName, int setNo)
{
	char message[64];
...
// 描画処理
//==========================================
void AnimationContainer::Draw(LPD3DXMATRIX worldMtx)
{
...
// アニメーションの切り替え処理
//==========================================
void AnimationContainer::ChangeAnim(UINT animID, float playSpeed, bool forceChange)
{
...
// 動作開始にかかる時間を設定
//==========================================
void AnimationContainer::SetShiftTime(UINT animID, float interval)
{
	//指定のアニメーションIDの存在をチェック
	if (animID > (UINT)animSetNum)
	{
...
//==========================================
HRESULT AnimationContainer::SetupCallbackKeyFrames(LPCSTR setName)
{
...
// アニメーションセット数取得処理
//==========================================
UINT AnimationContainer::GetNumAnimationSets()
{
...
// アニメーション中断イベントのKeyFramesを設置する
//==========================================
float AnimationContainer::GetPeriodAnimation()
{
